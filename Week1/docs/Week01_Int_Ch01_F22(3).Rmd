...
## Calculate the percentage of the Earth that is water with 95% CI's of 1%.
...
## What does R power analysis indicate for an appropriate sample size fir a 1% margin of error (1/2 95% CI)?
...
## Plot all variables among each other
